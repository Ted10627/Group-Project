...
<template>
  <div class="relative w-full h-full" @mousedown="onMouseDown" @touchstart="onTouchStart">
    ...
    <div class="hidden lg:block">
      ...
      >
        <img
          class="w-[28px] h-[28px]"
          :src="hoverL ? '/icon/hover-guide-left-arrow.png' : '/icon/guide-left-arrow.png'"
          alt="左按鈕"
        />
      </button>
      <button
      ...
      >
        <img
          class="w-[28px] h-[28px]"
          :src="hoverR ? '/icon/hover-guide-right-arrow.png' : '/icon/guide-right-arrow.png'"
          alt="右按鈕"
        />
      </button>
    </div>
