...
<template>
  ...
  <div class="px-5">
    <div class="w-full max-w-[1260px] flex flex-col gap-5 lg:gap-12 m-auto py-10">
      ...
      <mainTitle>
        <template #title>國際線出境流程</template>
      </mainTitle>
      <div class="flex flex-col lg:flex-row white rounded-[20px]">
        <div class="order-2 lg:order-1 flex-1 m-auto">
          <img src="/image/process-exit.jpg" alt="搭機流程說明圖(出境)" />
        </div>
        <div class="order-1 lg:order-2 flex-1 flex flex-col justify-center p-10 gap-10">
          <div>
            <p class="text-xl lg:text-3xl text-[#471C87]">注意事項 :</p>
            <p class="text-sm lg:text-2xl">
              請注意旅客應於航班起飛前2-3個小時，向所搭乘之航空公司報到櫃台辦理完成報到手續；最遲完成報到時間請以旅客所搭乘航空公司規定為準。
            </p>
          </div>
          <div>
