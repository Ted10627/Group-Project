...
<template>
  ...
  <div class="px-5">
    <div class="w-full max-w-[1260px] flex flex-col gap-5 lg:gap-12 m-auto py-10">
      ...
      <img class="airportmap" :src="currentImage" alt=""  @click="showImage">
      <div class="w-full text-sm lg:text-2xl">文章最後更新日期：2023-11-10</div>
    </div>
  </div>
  <div v-if="imageVisible" class="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50" @click="hideImage">
