        ...
        <div>
          <div class="w-full shadow-lg mb-3 flex flex-col lg:flex-row gap-0 bg-white">
            ...
            <div class="bg-white px-5 flex items-center grow py-4">
              ...
              <img class="searchicon w-[20px] h-[20px]" src="/icon/search.png" frameborder="0">
            </div>
          
            
          </div>
          <div v-for="(item, i) in formattedFaqData" :key="i">
            <div @click="toggle(i)" class="question flex justify-between items-center content-text text-air-purple bg-white shadow-lg">
              {{ item.question }}
              <img 
